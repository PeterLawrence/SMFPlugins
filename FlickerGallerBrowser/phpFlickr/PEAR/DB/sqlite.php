 ...
 * send a note to license <at> php <dot> net so we can mail you a copy immediately.
 *
 * @category   Database
 * @package    DB
 * @author     Urs Gehrig <urs <at> circle <dot> ch>
 * @author     Mika Tuupola <tuupola <at> appelsiini <dot> net>
 * @author     Daniel Convissor <danielc <at> php <dot> net>
